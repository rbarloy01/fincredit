...
Esta carpeta vive dentro de `fincredit` como herramienta auxiliar. No modifica la app web directamente; genera archivos locales bajo `tools/financial-monitor-pipeline/outputs/`, que el repo principal ignora por default.
