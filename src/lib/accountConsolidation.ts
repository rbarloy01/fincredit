...
export const BASE_CONSOLIDATION_RULES: AccountConsolidationRule[] = [
  ...
  { id: 'sys-cash', metric: 'cash', label: METRIC_LABELS.cash, aliases: ['efectivo', 'bancos', 'equivalentes de efectivo', 'disponibilidades'], statementType: 'balance_general', source: 'system', updatedAt: 'system' },
  ...
  { id: 'sys-past-due-portfolio', metric: 'pastDuePortfolio', label: METRIC_LABELS.pastDuePortfolio, aliases: ['cartera vencida', 'creditos vencidos', 'saldo vencido', 'cartera en mora', 'cartera morosa', 'cartera de credito con riesgo de credito etapa 3', 'riesgo de credito etapa 3', 'cartera de credito vencida'], statementType: 'balance_general', source: 'system', updatedAt: 'system' },
